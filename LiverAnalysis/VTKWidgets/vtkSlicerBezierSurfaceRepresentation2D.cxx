...
//----------------------------------------------------------------------
bool vtkSlicerBezierSurfaceRepresentation2D::GetTransformationReferencePoint(double referencePointWorld[3])
{
...
//----------------------------------------------------------------------
void vtkSlicerBezierSurfaceRepresentation2D::UpdatePlaneFillColorMap(vtkDiscretizableColorTransferFunction* colormap, double color[3])
{
...
//----------------------------------------------------------------------
void vtkSlicerBezierSurfaceRepresentation2D::UpdatePlaneOutlineColorMap(vtkDiscretizableColorTransferFunction* colormap, double color[3])
{
  Superclass::UpdateDistanceColorMap(colormap, color);
...
//-----------------------------------------------------------------------------
void vtkSlicerBezierSurfaceRepresentation2D::CanInteractWithPlane(
  vtkMRMLInteractionEventData* interactionEventData,
  int& foundComponentType, int& foundComponentIndex, double& closestDistance2)
{
  // Create the tree
...
//----------------------------------------------------------------------
void vtkSlicerBezierSurfaceRepresentation2D::BuildPlane()
{
  vtkMRMLMarkupsBezierSurfaceNode* markupsNode = vtkMRMLMarkupsBezierSurfaceNode::SafeDownCast(this->GetMarkupsNode());
...
//----------------------------------------------------------------------
void vtkSlicerBezierSurfaceRepresentation2D::UpdateInteractionPipeline()
{
  vtkMRMLMarkupsBezierSurfaceNode* planeNode = vtkMRMLMarkupsBezierSurfaceNode::SafeDownCast(this->GetMarkupsNode());
