...
//----------------------------------------------------------------------------
vtkMRMLMarkupsBezierSurfaceNode::~vtkMRMLMarkupsBezierSurfaceNode() = default;
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::CopyContent(vtkMRMLNode* anode, bool deepCopy/*=true*/)
{
  MRMLNodeModifyBlocker blocker(this);
...
//----------------------------------------------------------------------------
const char* vtkMRMLMarkupsBezierSurfaceNode::GetSizeModeAsString(int sizeMode)
{
  switch (sizeMode)
    {
  case SizeModeAuto:
...
//----------------------------------------------------------------------------
int vtkMRMLMarkupsBezierSurfaceNode::GetSizeModeFromString(const char* sizeMode)
{
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::GetNormal(double normal[3])
{
  if (!normal)
    {
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::GetNormalWorld(double normalWorld[3])
{
  if (!normalWorld)
    {
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::SetNormal(const double normal[3])
{
  if (!normal)
    {
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::SetNormalWorld(const double inNormal[3])
{
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::GetOrigin(double origin_Local[3])
{
  if (!origin_Local)
    {
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::GetOriginWorld(double origin_World[3])
{
  if (!origin_World)
    {
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::SetOrigin(const double origin_Local[3])
{
  if (!origin_Local)
    {
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::SetOriginWorld(const double origin_World[3])
{
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::CalculateAxesFromPoints(const double point0[3], const double point1[3], const double point2[3],
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::GetPlaneToLocalMatrix(vtkMatrix4x4* planeToLocalMatrix)
{
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::GetPlaneToWorldMatrix(vtkMatrix4x4* planeToWorldMatrix)
{
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::GetAxes(double xAxis_Local[3], double yAxis_Local[3], double zAxis_Local[3])
{
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::GetAxesWorld(double xAxis_World[3], double yAxis_World[3], double zAxis_World[3])
{
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::SetAxes(const double xAxis_Local[3], const double yAxis_Local[3], const double zAxis_Local[3])
{
  if (!xAxis_Local || !yAxis_Local || !zAxis_Local)
    {
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::SetAxesWorld(const double xAxis_World[3], const double yAxis_World[3], const double zAxis_World[3])
{
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::GetPlaneBounds(double PlaneBounds[6])
{
  if (this->GetNumberOfControlPoints() < 3)
    {
    for (int i = 0; i < 6; ++i)
  ...
  if (this->SizeMode == vtkMRMLMarkupsBezierSurfaceNode::SizeModeAuto)
    {
    double point0_Local[3] = { 0.0 };
    double point1_Local[3] = { 0.0 };
    double point2_Local[3] = { 0.0 };
...
//----------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::CreatePlane()
{
  if (this->GetNumberOfControlPoints() < 3)
    {
...
//----------------------------------------------------------------------------
vtkMatrix4x4* vtkMRMLMarkupsBezierSurfaceNode::GetPlaneToPlaneOffsetMatrix()
{
  return this->PlaneToPlaneOffsetMatrix;
}

//---------------------------------------------------------------------------
void vtkMRMLMarkupsBezierSurfaceNode::UpdateInteractionHandleToWorldMatrix()
{
...
//---------------------------------------------------------------------------
double vtkMRMLMarkupsBezierSurfaceNode::GetClosestPointOnPlaneWorld(const double posWorld[3], double closestPosWorld[3], bool infinitePlane/*=true*/)
{
  if (!posWorld)
    {
